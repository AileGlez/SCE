...
@NamedQueries({
    ...
    , @NamedQuery(name = "OrderedProduct.findOrderedProductByIdCustomerOrder", query = "SELECT o FROM OrderedProduct o WHERE o.orderedProductPK.customerOrderId = :customerOrderID")
})
